...
/** ------------------------------------------------------------ 
 *	UWirelessSignalSettings - 模块设置
 * 
 *  用途：
 *	1. 会在Editor模块SettingView构建时被用于UI构建
 */
...
/** ---UWirelessSignalSubsystem-------------------------------------------
 *  无线信号子系统，其UWorldSubsystem接口事件用于被对应UI所调用
 */
UCLASS()
