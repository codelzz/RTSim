...
IMPLEMENT_GLOBAL_SHADER(FVisualizeIrradianceCachePS, "/Plugin/WirelessSignal/Private/IrradianceCacheVisualization.usf", "VisualizeIrradianceCachePS", SF_Pixel);
...
FIrradianceCache::FIrradianceCache(int32 Quality, float Spacing, float CornerRejection)
{
	...
	UE_LOG(LogWirelessSignal, Log, TEXT("Irradiance cache initialized with %.2fMB"), IrradianceCacheTotalBytes / 1024.0f / 1024.0f);
