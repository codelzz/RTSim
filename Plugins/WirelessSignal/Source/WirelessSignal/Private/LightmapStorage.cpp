...
void FTileDataLayer::Evict()
{
	...
	{
		UE_LOG(LogWirelessSignal, Log, TEXT("CPU tile management: evicted %d tiles in %s, released %.2fMB"), OldNum - AllUncompressedTiles.Num(), *FPlatformTime::PrettyTime(EndTime - StartTime), EvictedMemorySize / 1024.0f / 1024.0f);
	}
}
