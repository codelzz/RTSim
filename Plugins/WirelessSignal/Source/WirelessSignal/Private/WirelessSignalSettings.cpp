...
// [Cannot find definition] int32 GWirelessSignalDenoiseGIOnCompletion = WITH_INTELOIDN;
int32 GWirelessSignalDenoiseGIOnCompletion = 1;
#if WITH_INTELOIDN
...
AWirelessSignalSettingsActor* UWirelessSignalSubsystem::GetSettingsActor()
{
	...
	for (TActorIterator<AWirelessSignalSettingsActor> It(World, 
		AWirelessSignalSettingsActor::StaticClass(), 
