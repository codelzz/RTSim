...
IMPLEMENT_MATERIAL_SHADER_TYPE(, FVLMVoxelizationVS, TEXT("/Plugin/WirelessSignal/Private/VolumetricLightmapVoxelization.usf"), TEXT("VLMVoxelizationVS"), SF_Vertex);
IMPLEMENT_MATERIAL_SHADER_TYPE(, FVLMVoxelizationGS, TEXT("/Plugin/WirelessSignal/Private/VolumetricLightmapVoxelization.usf"), TEXT("VLMVoxelizationGS"), SF_Geometry);
IMPLEMENT_MATERIAL_SHADER_TYPE(, FVLMVoxelizationPS, TEXT("/Plugin/WirelessSignal/Private/VolumetricLightmapVoxelization.usf"), TEXT("VLMVoxelizationPS"), SF_Pixel);
IMPLEMENT_GLOBAL_SHADER(FClearVolumeCS, "/Plugin/WirelessSignal/Private/BrickAllocationManagement.usf", "ClearVolumeCS", SF_Compute);
IMPLEMENT_GLOBAL_SHADER(FVoxelizeImportanceVolumeCS, "/Plugin/WirelessSignal/Private/BrickAllocationManagement.usf", "VoxelizeImportanceVolumeCS", SF_Compute);
IMPLEMENT_GLOBAL_SHADER(FDilateVolumeCS, "/Plugin/WirelessSignal/Private/BrickAllocationManagement.usf", "DilateVolumeCS", SF_Compute);
IMPLEMENT_GLOBAL_SHADER(FDownsampleVolumeCS, "/Plugin/WirelessSignal/Private/BrickAllocationManagement.usf", "DownsampleVolumeCS", SF_Compute);
IMPLEMENT_GLOBAL_SHADER(FCountNumBricksCS, "/Plugin/WirelessSignal/Private/BrickAllocationManagement.usf", "CountNumBricksCS", SF_Compute);
IMPLEMENT_GLOBAL_SHADER(FGatherBrickRequestsCS, "/Plugin/WirelessSignal/Private/BrickAllocationManagement.usf", "GatherBrickRequestsCS", SF_Compute);
IMPLEMENT_GLOBAL_SHADER(FSplatVolumeCS, "/Plugin/WirelessSignal/Private/BrickAllocationManagement.usf", "SplatVolumeCS", SF_Compute);
IMPLEMENT_GLOBAL_SHADER(FStitchBorderCS, "/Plugin/WirelessSignal/Private/BrickAllocationManagement.usf", "StitchBorderCS", SF_Compute);
IMPLEMENT_GLOBAL_SHADER(FFinalizeBrickResultsCS, "/Plugin/WirelessSignal/Private/BrickAllocationManagement.usf", "FinalizeBrickResultsCS", SF_Compute);
...
void SetupPathTracingLightParameters(const WirelessSignal::FLightSceneRenderState& LightScene, FRDGBuilder& GraphBuilder, FRDGBufferSRV** OutLightBuffer, uint32* OutLightCount);
...
void FVolumetricLightmapRenderer::VoxelizeScene()
{
	...
	UE_LOG(LogWirelessSignal, Log, TEXT("Volumetric lightmap voxelization bounds set to (%.2f, %.2f, %.2f) - (%.2f, %.2f, %.2f)"),
		FinalVolume.Min.X,
		FinalVolume.Min.Y,
		FinalVolume.Min.Z,
		FinalVolume.Max.X,
...

	{
		...
		GRenderTargetPool.FindFreeElement(FRHICommandListExecutor::GetImmediateCommandList(), Desc, IndirectionTexture, *FString::Printf(TEXT("WirelessSignalVLMIndirectionTexture")));
	}
	...
	for (int32 Level = 0; Level < MaxRefinementLevels; Level++)
	{
		...
		// UE_LOG(LogWirelessSignal, Log, TEXT("Creating voxelization mip%d %d %d %d"), Level, IndirectionTextureDimensions.X >> (Level * BrickSizeLog2), IndirectionTextureDimensions.Y >> (Level * BrickSizeLog2), IndirectionTextureDimensions.Z >> (Level * BrickSizeLog2));

		GRenderTargetPool.FindFreeElement(FRHICommandListExecutor::GetImmediateCommandList(), Desc, VoxelizationVolumeMips.Last(0), *FString::Printf(TEXT("WirelessSignalVLMVoxelizationVolumeMips%d"), Level));
	}
	...
	SCOPED_DRAW_EVENTF(RHICmdList, WirelessSignalVoxelizeScene, TEXT("WirelessSignal VoxelizeScene"));
	...
	check(NumBricksReadback.IsReady());
	{
		...
		UE_LOG(LogWirelessSignal, Log, TEXT("Volumetric lightmap NumTotalBricks = %d"), NumTotalBricks);
